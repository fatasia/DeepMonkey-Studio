...
2026-09-16 22:26 更新：已接生产发布记录/资源读取、真实编译 bundle、Native 绘制回执、API 启动注册、候选登记、DMDA/ZIP/单 EXE 下载。隔离磁盘发布的两形状应用经真实窗口验证后下载单 EXE，在无旁置文件、PATH 仅 System32 下无参数成功呈现。客户项目、完整内容/交互、登录与恢复矩阵仍待验收；下方早期进展保留作历史记录。
