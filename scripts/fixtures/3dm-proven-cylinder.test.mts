...
const root=resolve(import.meta.dirname,'../..'),out=resolve(root,'test-output/industrial-3dm/polynomial-bezier-2026-09-17-v1/proven');
...
test('four uncached source faces prove circle identity and preserve PointAt, boundaries and GLB',async()=>{
  ...
  for(const [name,faces,expected,hash] of [['A',[1,2,3],33,'a1b0ef69925b5d9223a7d797033055bb766842768a96f7713e1ecaec2763bb31'],
