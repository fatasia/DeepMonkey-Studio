...
const REQUIRED_TEXT = {
  "LICENSE": [
    ...
    "fails to pay wages, bonuses, performance compensation, overtime",
  ...
  "LICENSING.md": ["Usage matrix", "source-available", "LicenseRef-Deep-Monkey-Community-1.0", "Covered Misconduct"],
