...
The default champagne alpaca brand image (`apps/web/public/brand/logo-source.png`) is a project brand asset, not a third-party stock image. Its original PNG is preserved; SVG, PNG, ICO and ICNS derivatives are generated locally. No new library or font dependency is introduced.
