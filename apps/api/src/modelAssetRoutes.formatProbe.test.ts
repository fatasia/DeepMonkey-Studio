...
function modelFixture(): ModelRecord {
  return {
    id: "model-1", projectId: "project-1", name: "part.x_b", format: "x_b", size: 1, status: "queued", progress: 0,
    message: "等待转换", sourceUrl: "/assets/projects/project-1/models/model-1/source/part.x_b", createdAt: new Date(0).toISOString(), updatedAt: new Date(0).toISOString(),
  };
}
