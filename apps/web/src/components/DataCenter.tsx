...
function connectionLabel(type: DataConnectionType) { return ({ postgresql: "PostgreSQL", mysql: "MySQL", oracle: "Oracle", tdengine: "TDengine", http: "HTTP API", websocket: "WebSocket", "node-red": "Flow bridge", mqtt: "MQTT", opcua: "OPC UA", modbus: "Modbus TCP", bacnet: "BACnet", tcp: "TCP", udp: "UDP", serial: "Serial", s7: "Siemens S7", "ethernet-ip": "EtherNet/IP", snmp: "SNMP", amqp: "AMQP", kafka: "Kafka", coap: "CoAP" } as Record<DataConnectionType, string>)[type]; }
