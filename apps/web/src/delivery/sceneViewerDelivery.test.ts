...
function manifest() {
  ...
  return {
    ...
    branding: { systemName: "Industrial Studio", browserTitle: "工作站", loginSubtitle: "", copyright: "", logoUrl: "/brand/logo-industrial.svg", iconUrl: "/brand/app-icon-industrial.svg", primaryColor: "#d6aa4d", defaultLocale: "zh-CN", defaultEntry: "manager", defaultSceneBackground: "#202a31", defaultGridVisible: true, maintenanceEnabled: false, maintenanceMessage: "" },
    assets: [],
  };
}
