// one-off: serve probe4 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe4.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe4.js") { filePath = resolve(probeDir, "probe4.js"); contentType = "text/javascript; charset=utf-8"; }
...
try {
  ...
  try {
    ...
    throw new Error("probe4 timeout");
  }
