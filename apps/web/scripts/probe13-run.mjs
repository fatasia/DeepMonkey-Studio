// one-off: serve probe13 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe13.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe13.js") { filePath = resolve(probeDir, "probe13.js"); contentType = "text/javascript; charset=utf-8"; }
...
try {
  ...
  fs.writeFileSync(resolve(probeDir, "probe13-results.json"),
