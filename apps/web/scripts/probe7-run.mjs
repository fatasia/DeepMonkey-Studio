// one-off: serve probe7 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe7.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe7.js") { filePath = resolve(probeDir, "probe7.js"); contentType = "text/javascript; charset=utf-8"; }
...
try {
  ...
  try {
    ...
    throw new Error("probe7 timeout");
  }
