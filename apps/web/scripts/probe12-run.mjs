// one-off: serve probe12 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe12.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe12.js") { filePath = resolve(probeDir, "probe12.js"); contentType = "text/javascript; charset=utf-8"; }
...
try {
  ...
  fs.writeFileSync(resolve(probeDir, "probe12-results.json"),
