// one-off: serve probe14 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe14.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe14.js") { filePath = resolve(probeDir, "probe14.js"); contentType = "text/javascript; charset=utf-8"; }
...
try {
  ...
  fs.writeFileSync(resolve(probeDir, "probe14-results.json"),
