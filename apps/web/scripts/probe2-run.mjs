// one-off: serve probe2 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe2.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe2.js") { filePath = resolve(probeDir, "probe2.js"); contentType = "text/javascript; charset=utf-8"; }
