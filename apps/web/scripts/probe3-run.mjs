// one-off: serve probe3 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe3.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe3.js") { filePath = resolve(probeDir, "probe3.js"); contentType = "text/javascript; charset=utf-8"; }
