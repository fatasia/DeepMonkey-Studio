// one-off: serve probe6 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe6.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe6.js") { filePath = resolve(probeDir, "probe6.js"); contentType = "text/javascript; charset=utf-8"; }
...
try {
  ...
  try {
    ...
    throw new Error("probe6 timeout");
  }
