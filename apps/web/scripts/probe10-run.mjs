// one-off: serve probe10 page and print results
...
const server = createServer((request, response) => {
  ...
  if (pathname === "/") { filePath = resolve(probeDir, "probe10.html"); contentType = "text/html; charset=utf-8"; }
  else if (pathname === "/probe10.js") { filePath = resolve(probeDir, "probe10.js"); contentType = "text/javascript; charset=utf-8"; }
...
try {
  ...
  fs.writeFileSync(resolve(probeDir, "probe10-results.json"),
