...
- Restore the Deep Monkey Community Source License 1.0 (`DMCSL-1.0`) as the sole project license (2026-09-25 owner decision), superseding the interim MIT-plus-ethical-restrictions text: `LICENSE` and `LICENSE.zh-CN.md` return to the community source license, `LICENSE-RESTRICTIONS.md` is removed, and README, `LICENSING.md`, `AGENTS.md`, contribution terms, package metadata, and governance assertions are back on the `LicenseRef-Deep-Monkey-Community-1.0` wording.
